...
func (q *Queries) RemoveFeedFollow(ctx context.Context, arg RemoveFeedFollowParams) (FeedFollow, error) {
	row := q.db.QueryRowContext(ctx, removeFeedFollow, arg.UserID, arg.Url)
	var i FeedFollow
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
